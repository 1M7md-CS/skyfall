	...
	return (
		...
		>
			...
			<div className="flex flex-col gap-1.5 lg:gap-2.5 xl:gap-3.5">
				<h2 className="font-semibold text-2xl lg:text-[30px] xl:text-[38px] leading-tight">
					Let us Bring your Ideas to Life in the Digital World.
				</h2>

				<p
					className="tracking-minus06 text-muted-foreground leading-6
			...
			{/* Action Button */}
			<Button
				className="font-playfair w-fit self-center
                               px-6 xl:px-[34px]
                               py-[14px] xl:py-[18px]"
			>
				<span
					className="font-medium text-muted-foreground tracking-minus06
